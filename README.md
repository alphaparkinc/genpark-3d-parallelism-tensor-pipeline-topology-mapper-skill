# genpark-3d-parallelism-tensor-pipeline-topology-mapper-skill
...
> **GenPark AI Agent Skill** -- 3D parallelism tensor, pipeline & sequence topology mapper (Megatron-LM style)
